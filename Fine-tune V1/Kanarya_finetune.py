...
model = AutoModelForCausalLM.from_pretrained("asafaya/kanarya-750m", return_dict=True)
...
# Modeli kaydet
model.save_pretrained("./finetuned_kanarya_v1")
tokenizer.save_pretrained("./finetuned_kanarya_v1")